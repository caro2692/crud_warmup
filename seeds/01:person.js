...
exports.seed = function(knex, Promise) {
  ...
  return knex.raw('TRUNCATE person CASCADE; ALTER SEQUENCE person_id_seq restart with 6')
    .then(function () {
      // Inserts seed entries
      const salt = bcrypt.genSaltSync(saltRounds);

      return knex('person').insert([
        {id: 1, first_name: 'Carter', last_name:'Hunter', email:'cchxp@virginia.edu', password:bcrypt.hashSync('password123', salt)},
